...
# from ai_companion.modules.memory import get_resume_rag_vector_store
...
async def process_pdfs():
    ...
    try:
        ...
        for pdf_filename in new_pdfs_to_process:
            ...
            # Placeholder for PDF processing (reading, chunking, embedding, Qdrant upload)
            ...
            # 3. Store chunks in Qdrant using the new vector store
