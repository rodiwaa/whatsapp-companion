...
def create_workflow_graph():
    ...
    # graph_builder.add_edge(START, "memory_extraction_node") ## FIXME:
    ...
    # graph_builder.add_edge("router_node", "context_injection_node") # FIXME:
    # graph_builder.add_edge("context_injection_node", "memory_injection_node") # FIXME:
    graph_builder.add_edge("router_node", "memory_injection_node")


    # Then proceed to appropriate response node
    # graph_builder.add_conditional_edges("memory_injection_node", "select_workflow") ## FIXME:
